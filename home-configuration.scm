...
(define my-packages
  ...
  "biber" "borg" "brightnessctl" "bsd-games" "btrfs-progs" "carp" "cbqn"
  ...
  "file" "fluid-3" "fluidsynth" "font-3270" "font-bqn386" ;"fnlfmt"
  ...
  "git:send-email" "git-filter-repo" "glibc-locales" "gnupg" "gnurobots"
  "gparted" "graphviz" "grep" "guildhall" "guile" "guile-bash"
  ...
  "plantuml" "poppler" "portmidi" "postgresql" "pulseaudio" "python"
