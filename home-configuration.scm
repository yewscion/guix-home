...
(define my-packages
  ...
  "openjdk:doc" "openjdk:jdk" "optipng" "orca-music" "owl-lisp" "pagr"
  "pamixer" "password-store" "patchelf" "patchelf-wrapper" "pavucontrol"
  "perl" "perl-image-exiftool" "picolisp" "pinentry-emacs" "pkg-config"
  ...
  "python-pygments-pseudotaxus" "qemu" "rebar3""ripgrep" "rlwrap" "rsync"
  "ruby" "ruby-kramdown" "rxvt-unicode" "sbcl" "sbcl-deploy" "sbcl-esrap"
  "sbcl-ironclad" "sbcl-stumpwm-battery-portable" "sbcl-stumpwm-notify"
  ...
  "texlive-xcolor" "texlive-xifthen" "texmacs" "the-silver-searcher"
  "timidity++" "tintin++" "transmission" "tree" "universal-ctags" "unzip"
  "uxn" "virt-manager" "virt-viewer" "vlang" "wesnoth" "which"
  "wine64-staging" "wordnet" "xapian" "xboard" "xdg-utils" "xdotool"
  "xdpyprobe" "xindy" "xfontsel" "xkeyboard-config" "xmp" "xprop" "xrdb"
