...
(define my-packages
  ...
  "postgresql" "pseudotaxus" "pulseaudio" "python"
  "python-css-html-js-minify" "python-lsp-server" "python-pygments"
  "python-pygments-pseudotaxus" "qemu" "ripgrep" "rlwrap" "rsync" "ruby"
  "ruby-kramdown" "rxvt-unicode" "sbcl" "sbcl-deploy" "sbcl-esrap"
