...
;;;; Graveyard
                                        ...
                                        ; emacs-webpaste - emacs-deferred
                                        ; dependency through emacs-request
                                        ; emacs-slack - same
                                        ; emacs-org-web-tools - same
                                        ; emacs-lsp-java - same
                                        ; emacs-tldr - same
                                        ; emacs-company-jedi - same
                                        ; emacs-jedi - same
                                        ; emacs-request - same
...
"emacs-async" "emacs-avy" "emacs-biblio" "emacs-bongo" "emacs-bui" "emacs-caml"
"emacs-chess" "emacs-cider" "emacs-circe" "emacs-citar" "emacs-citeproc-el"
"emacs-clojure-mode" "emacs-cmake-mode" "emacs-company" "emacs-company-emoji"
 "emacs-company-lsp" "emacs-company-lua"
...
"emacs-csv-mode" "emacs-d-mode" "emacs-daemons" "emacs-dash" "emacs-datetime"
"emacs-debbugs" "emacs-deft" "emacs-dictionary" "emacs-diff-hl"
"emacs-disable-mouse" "emacs-dmenu" "emacs-docker" "emacs-docker-compose-mode"
...
"emacs-elfeed-protocol" "emacs-elisp-docstring-mode"
"emacs-elisp-slime-nav" "emacs-elixir-mode"  "emacs-elpher"
"emacs-elpy" "emacs-emacsql" "emacs-emacsql-sqlite3" "emacs-embark" "emacs-emms"
"emacs-emms-mode-line-cycle" "emacs-emojify" "emacs-engine-mode" "emacs-epl"
"emacs-eprime" "emacs-erc-hl-nicks" "emacs-erlang" "emacs-eshell-did-you-mean"
"emacs-eshell-syntax-highlighting" "emacs-ess" "emacs-esup" "emacs-esxml"
"emacs-eterm-256color" "emacs-eww-lnum" "emacs-exiftool" "emacs-extempore-mode"
"emacs-f" "emacs-fennel-mode" "emacs-ffap-rfc-space"
...
"emacs-geiser" "emacs-geiser-chez" "emacs-geiser-gauche" "emacs-geiser-guile"
"emacs-geiser-racket" "emacs-gif-screencast" "emacs-git-modes" "emacs-gnuplot"
"emacs-gntp" "emacs-google-translate" "emacs-graphql" "emacs-graphql-mode"
"emacs-graphviz-dot-mode" "emacs-guix" "emacs-ht"
"emacs-html-to-hiccup" "emacs-htmlize" "emacs-hy-mode" "emacs-hydra"
"emacs-hyperbole" "emacs-iedit" "emacs-inf-janet" "emacs-inf-ruby"
"emacs-janet-mode" "emacs-jinja2-mode" "emacs-json-mode"
"emacs-json-snatcher" "emacs-jsonnet-mode" "emacs-julia-mode" "emacs-julia-repl"
"emacs-julia-snail" "emacs-key-chord" "emacs-keycast" "emacs-kibit-helper"
"emacs-know-your-http-well" "emacs-kv" "emacs-ledger-mode"
"emacs-leetcode" "emacs-libmpdel" "emacs-lice-el" "emacs-lisp-extra-font-lock"
"emacs-lispy" "emacs-log4e" "emacs-logview" "emacs-lorem-ipsum" "emacs-lua-mode"
"emacs-macrostep" "emacs-magit" "emacs-magit-annex" "emacs-magit-gerrit"
"emacs-magit-popup" "emacs-make-it-so" "emacs-marginalia" "emacs-markdown-mode"
...
"emacs-npm-mode" "emacs-oauth2" "emacs-ob-async" "emacs-org" "emacs-org-brain"
"emacs-org-contrib" "emacs-org-cv" "emacs-org-download" "emacs-org-drill"
"emacs-org-drill-table" "emacs-org-emms" "emacs-org-journal"
"emacs-org-mind-map" "emacs-org-msg" "emacs-org-noter" "emacs-org-pandoc-import"
"emacs-org-pomodoro" "emacs-org-present" "emacs-org-re-reveal" "emacs-org-ref"
"emacs-org-roam" "emacs-org-vcard" "emacs-ox-epub"
"emacs-ox-gemini" "emacs-ox-gfm" "emacs-ox-haunt" "emacs-ox-pandoc"
"emacs-pandoc-mode" "emacs-paredit" "emacs-parsebib" "emacs-parseclj"
"emacs-parseedn" "emacs-pass" "emacs-password-store" "emacs-password-store-otp"
"emacs-pcre2el" "emacs-pdf-tools" "emacs-peg" "emacs-php-mode" "emacs-picpocket"
...
"emacs-psc-ide" "emacs-pulseaudio-control" "emacs-puni" "emacs-purescript-mode"
...
"emacs-shift-number" "emacs-simple-httpd" "emacs-simple-mpc" "emacs-skeletor"
"emacs-skewer-mode" "emacs-slime" "emacs-slime-company"
"emacs-slime-repl-ansi-color" "emacs-slime-volleyball" "emacs-sml-mode"
"emacs-so-long" "emacs-spark" "emacs-sparql-mode" "emacs-spinner" "emacs-sqlite"
"emacs-srfi" "emacs-ssh-agency" "emacs-ssh-config-mode" "emacs-strace-mode"
"emacs-stream" "emacs-string-inflection" "emacs-stripe-buffer"
"emacs-stumpwm-mode" "emacs-sudo-edit" "emacs-suggest" "emacs-svg-icon"
"emacs-svg-lib" "emacs-svg-tag-mode" "emacs-sx" "emacs-symon" "emacs-synosaurus"
"emacs-systemd-mode" "emacs-tablist" "emacs-tagedit" "emacs-tco-el" "emacs-tide"
"emacs-toc-org" "emacs-toml-mode" "emacs-transient"
...
"emacs-web-server" "emacs-webfeeder" "emacs-websocket"
"emacs-wget" "emacs-which-key" "emacs-whitespace-cleanup-mode" "emacs-wisp-mode"
...
;;;; LaTeX
(define my-texlive-packages (list "biber" "extractpdfmark" "texlive-biblatex"
"texlive-biblatex-apa" "texlive-booktabs" "texlive-capt-of" "texlive-csquotes"
...
"texlive-latex-ifplatform" "texlive-latex-kvoptions" "texlive-latex-letltxmacro"
"texlive-latex-lineno" "texlive-latex-lipsum" "texlive-latex-lwarp"
"texlive-latex-memoir" "texlive-latex-minted" "texlive-latex-newfloat"
...
"texlive-latex-upquote" "texlive-latex-xkeyval" "texlive-latex-xpatch"
"texlive-libkpathsea" "texlive-listings" "texlive-lm" "texlive-luaotfload"
...
"rust" "sassc" "sbcl" "sbcl-stumpwm-battery-portable" "sbcl-stumpwm-screenshot"
"sbcl-zpng" "slang" "swi-prolog" "texinfo" "universal-ctags" "vlang"))
;;;; System Stuff
(define my-system-packages (list "alsa-plugins" "alsa-plugins:pulseaudio" "bash"
"btrfs-progs" "coreutils" "curl" "dfc" "docker" "dosfstools" "efibootmgr"
"erofs-utils" "es" "espeak-ng" "exa" "exfat-utils" "exfatprogs" "exomizer"
"expect" "extundelete" "gash" "glibc-locales" "gnupg" "gparted" "grep" "icecat"
"le-certs" "libvirt" "links" "lxc" "mc" "ncdu" "netcat" "nmap" "nss-certs"
"password-store" "pavucontrol" "postgresql" "qemu" "ripgrep" "rxvt-unicode"
"sed" "sedsed" "setxkbmap" "shepherd" "sqlite" "sshfs" "sshpass" "stumpwm" "stumpwm:lib"
"the-silver-searcher" "tree" "virt-manager" "virt-viewer" "which" "wireshark"
"wordnet" "xdpyprobe" "yt-dlp" "zenity" "zutils"))
;;;; Userland/Etc
(define my-user-packages (list "adlmidi" "ardour" "b3sum" "beets" "borg"
"brasero" "bsd-games" "endless-sky" "evince" "exempi" "exercism" "filters"
"fluid-3" "fluidsynth" "font-gnu-freefont" "font-gnu-unifont" "font-tex-gyre"
