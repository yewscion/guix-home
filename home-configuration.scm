...
(define my-packages
  ...
  "emacs-git-modes" "emacs-gnu-apl-mode" "emacs-graphviz-dot-mode"
  "emacs-guix" "emacs-ht" "emacs-html-to-hiccup" "emacs-htmlize"
  "emacs-hy-mode" "emacs-hyperbole" "emacs-iedit" "emacs-inf-janet"
  "emacs-inf-ruby" "emacs-janet-mode" "emacs-jinja2-mode" "emacs-json-mode"
  "emacs-json-snatcher" "emacs-jsonnet-mode" "emacs-keycast"
  "emacs-know-your-http-well" "emacs-kv" "emacs-libmpdel"
  ...
  "knock" "le-certs" "libreoffice" "libvirt" "links" "lxc" "make" "maven"
  "mc" "milkytracker" "mono" "mpv" "msmtp" "mu" "my-frotz" "nasm" "ncdu"
  ...
  "texlive-etoolbox" "texlive-fontspec" "texlive-generic-etexcmds"
